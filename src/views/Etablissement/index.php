...
$etabs = $etablissementController->index();
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <p class="page-description">
                        ...
                        impliqués dans le processus de correction des examens.
                    </p>
                </div>
                        ...
                        <?php if ($totalEtabs > 0): ?>
                            <?php foreach ($etabs as $etab): ?>
                                <tr>
                                    ...
                                    <td><?= $etab->getVille() ?></td>
                                    <td>
                                        <a href="formulaire.php?id=<?= $etab->getId() ?>" class="btn btn-sm btn-outline-primary actions-btn">
                                            <i class="fas fa-edit"></i> Modifier
                                        </a>
                                        <a href="supprimer.php?id=<?= $etab->getId() ?>" class="btn btn-sm btn-outline-danger actions-btn">

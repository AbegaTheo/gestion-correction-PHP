...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    ...
    $error = "Aucune correction spécifiée pour la suppression.";
    ...
    if (isset($_POST['confirm']) && $_POST['confirm'] === 'yes') {
        ...
        if ($success) {
            ...
            $error = "Erreur lors de la suppression de la fiche correction. Veuillez réessayer.";
            $showConfirmation = false;
        }
    }
}
...
?>
    ...
    <title>Supprimer une correction - Gestion de correction</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-danger text-white">
                    <h4><i class="fas fa-trash-alt me-2"></i> Suppression d'une correction</h4>
                </div>
                <div class="card-body">
                    <?php if (isset($error)): ?>
                    ...
                    <?php elseif ($showConfirmation): ?>
                        ...
                        <p class="lead">Êtes-vous sûr de vouloir supprimer cette correction ?</p>
                        <p>Une fois supprimé, toutes les données associées à cette correction seront définitivement perdues.</p>

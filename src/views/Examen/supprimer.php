...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    ...
    $error = "Aucun examen spécifié pour la suppression.";
    ...
    if (isset($_POST['confirm']) && $_POST['confirm'] === 'yes') {
        ...
        $success = $examenController->delete($id);
        ...
        if ($success) {
            ...
            $error = "Erreur lors de la suppression du examen. Veuillez réessayer.";
            $showConfirmation = false;
        }
    }
}
...
?>
    ...
    <title>Supprimer un examen - Gestion de correction</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-danger text-white">
                    <h4><i class="fas fa-trash-alt me-2"></i> Suppression d'un examen</h4>
                </div>
                <div class="card-body">
                    <?php if (isset($error)): ?>
                    ...
                    <?php elseif ($showConfirmation): ?>
                        ...
                        <p class="lead">Êtes-vous sûr de vouloir supprimer cet examen ?</p>
                        <p>Une fois supprimé, toutes les données associées à cet examen seront définitivement perdues.</p>
